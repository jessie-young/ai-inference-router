...
server.listen(port, () => {
  ...
  console.log('');
  console.log('This is a server: it stays quiet until something calls it.');
  console.log('Nothing will appear below until you do BOTH of these:');
  console.log('');
  console.log('  Terminal 2 — start the router pointed here:');
  console.log('    MOCK_API_KEY=demo CONFIG_PATH=demo/config.demo.yaml npm start');
  console.log('');
  console.log('  Terminal 3 — send it a request:');
  console.log("    curl -s localhost:8080/v1/chat/completions \\");
  console.log("      -H 'content-type: application/json' \\");
  console.log('      -d \'{"model":"demo/error-500","messages":[{"role":"user","content":"hi"}]}\'');
  console.log('');
  console.log('Or run everything at once:  ./demo/run-mock-demo.sh');
  console.log('');
